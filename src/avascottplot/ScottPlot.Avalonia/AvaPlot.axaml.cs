...
namespace ScottPlot.Avalonia
{
    ...
    public partial class AvaPlot : UserControl
    {
        ...
        //    Task<string> filenameTask = new Task<string>();
        //    return;


        //    //var png = new Ava.Platform.Storage.FilePickerFileType("PNG Files");
        //    //png.Patterns = new List<string>() { "*.png" };
        //    //var jpg = new Ava.Platform.Storage.FilePickerFileType("JPG Files");
        //    //png.Patterns = new List<string>() { "*.jpg", "*.jpeg" };
        //    //var bmp = new Ava.Platform.Storage.FilePickerFileType("BMP Files");
        //    //png.Patterns = new List<string>() { "*.bmp" };
        //    //var tif = new Ava.Platform.Storage.FilePickerFileType("TIF Files");
        //    //png.Patterns = new List<string>() { "*.tif" };
        //    //var all = new Ava.Platform.Storage.FilePickerFileType("All Files");
        //    //png.Patterns = new List<string>() { "*.*" };

        //    //var filePicker = new Ava.Platform.Storage.FilePickerSaveOptions();
        //    //filePicker.FileTypeChoices = new List<Ava.Platform.Storage.FilePickerFileType> {
        //    //   png,jpg,bmp,tif,all
        //    //};

        //    //var tt = new  StorageProvider.SaveFilePickerAsync(filePicker);
